...
pub mod spawner {
    ...
    fn gen_room_13246886194600585633(w: IWorldDispatcher, playerid: felt252) {// object 4405246086034713577// action 16332049259031098349
        let mut action_4405246086034713577_16332049259031098349 = Action{
            actionId: st::NONE, 
            actionType: zrk::ActionType::None,  
        ...
        let mut action_15610790850353037754_12578911564611469734 = Action{
            actionId: st::NONE, 
            actionType: zrk::ActionType::None,  
            dBitTxt: "the dynamite detonates and luckily the blast wave passes through you. 
you shit your pants involuntarily. 
you are spared the clean up by dint of now being largely composed of meaty paste.
death. pffft", enabled: false, 
        ...
        let mut action_15610790850353037754_6636732390253036532 = Action{
            actionId: st::NONE, 
            actionType: zrk::ActionType::None,  
            dBitTxt: "the fuse comes into menacing life, sparkling like a demented god, 
the air fills with the smell of gunpowder. this is not at all unpleasant", enabled: true, 
            revertable: false, dBit: false, 
            affectsActionId: 0,
            affectedByActionId: 0
        };
        ...
        let object_desc: ByteArray = "a stick of slightly sweaty dynamite almost like a caricature of itself.\nIt's fused, certainly unstable and capable of turning things (including you)into a fine meaty mist \nstill holding exciteable explosives couldn't hurt right?";
        let td_id_b = h_util::str_hash(@object_desc);
    ...
    fn gen_room_8892581999139148090(w: IWorldDispatcher, playerid: felt252) {// object 745772409139972109// action 14833044636746871315
        ...
        let object_desc: ByteArray = "path leads east";
        let td_id_b = h_util::str_hash(@object_desc);
