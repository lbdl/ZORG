...
declare module '$env/static/private' {
	...
	export const PR_BOLD_BLUE: string;
	...
	export const PR_BOLD_RED: string;
	export const TMUX: string;
	export const NODE: string;
	export const __CFBundleIdentifier: string;
	export const PR_BOLD_BLACK: string;
	export const SSH_AUTH_SOCK: string;
	export const PR_RED: string;
	...
	export const PR_BOLD_YELLOW: string;
	export const EDITOR: string;
	export const PR_BLUE: string;
	...
	export const PR_YELLOW: string;
	export const XPC_SERVICE_NAME: string;
	export const npm_config_user_agent: string;
	export const PR_BLACK: string;
	export const npm_execpath: string;
	export const PR_BOLD_WHITE: string;
	export const NODE_PATH: string;
	export const PYENV_ROOT: string;
	export const npm_package_json: string;
	export const PR_WHITE: string;
	export const LC_COLLATE: string;
	export const XDG_DATA_DIRS: string;
	export const PATH: string;
	export const PR_BOLD_GREEN: string;
